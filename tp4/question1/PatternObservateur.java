...
public class PatternObservateur extends junit.framework.TestCase {
    ...
    public void test1() {
        ...
        assertEquals(2, o1.senders().size()); // o1 doit avoir ete notifie 2 fois
        assertEquals(2, o2.senders().size()); // o2 doit avoir ete notifie 2 fois
    ...
    public void test2() {
        ...
        assertEquals(4, o.senders().size()); // o doit avoir ete notifie 4 fois
    ...
    public void test3() {
        ...
        assertEquals(2, l1.countObservers()); // l1 doit avoir 2 observateurs
        assertEquals(2, l2.countObservers()); // l2 doit avoir 2 observateurs

        l1.deleteObserver(o1);
        assertEquals(1, l1.countObservers()); // l1 doit maintenant avoir 1 observateur
        l1.deleteObserver(o2);

        l2.deleteObservers();
        assertEquals(0, l2.countObservers()); // l2 ne doit avoir aucun observateur
